...
pub mod strict_codec {
    use super::{
        AuthoritativeEventV1, FixtureAuthorizationDecisionV1, BTreeMap, FixtureCapabilityGrantV1,
        ...
        PluginFailureClassV1, PluginFailureV1, FixturePrincipalRefV1, ProjectionEvidenceV1,
