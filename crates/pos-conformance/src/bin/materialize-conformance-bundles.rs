    ...
    profile
        ...
        .try_for_each(|fixture| {
            fixture
                .transition
                .as_ref()
                .ok_or_else(|| Box::<dyn Error>::from("downgrade fixture has no transition"))
                .and_then(|transition| {
                    fixture
                        .trust_policy_snapshot_digest
                        .ok_or_else(|| {
                            Box::<dyn Error>::from("downgrade fixture has no trust-policy digest")
                        })
                        .and_then(|trust_snapshot| {
