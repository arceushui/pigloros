...
by ADR-069. Canonical CBOR vectors in `vectors/sandbox-provider-v1` are decoded
by both `pos-conformance` and the independently implemented `pos-reference`
consumer. Systemd, OCI, youki, installation paths, and mutable host state are
