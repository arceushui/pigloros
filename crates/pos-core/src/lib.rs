...
pub use erasure::{
    ...
    ERASURE_FREEZE_PROVENANCE_TAG_V1, ERASURE_MAX_ADMINISTRATIVE_RESOLUTIONS,
    ERASURE_MAX_ATTEMPT_OUTCOMES, ERASURE_MAX_INVENTORY_RESULTS, ERASURE_MAX_OBLIGATIONS,
    ERASURE_MAX_OBLIGATIONS_PER_CATEGORY, ERASURE_MAX_REFERENCES, ERASURE_MAX_SCOPE_EXTENSIONS,
