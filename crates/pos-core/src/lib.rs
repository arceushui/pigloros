...
pub use erasure::{
    ...
    ArtifactDataClassV1, ArtifactKeyDependencyV1, ArtifactOptionalityV1, ArtifactRedactionStateV1,
    ...
    ReplayArtifactAuthorizationV1, ReplayClaimEvaluationV1, ReplayClaimEvaluatorV1,
