...
pub use consent::{
    ...
    ConsentCodecError, ConsentError, ConsentGate, ConsentGranted, ConsentGrantedV1,
    ConsentRevocationFoldListener, ConsentRevoked, ConsentRevokedV1, EVENT_TYPE_CONSENT_GRANTED_V1,
