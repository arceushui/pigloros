...
pub use erasure::{
    ...
    ErasureCoordinatorPortV1, ErasureCoordinatorStateMachineV1,
    ErasureCorrectionProvenanceInputV1,
    ...
    ErasureFreezeProvenanceV1, ErasureGate, ErasureIndexInsertV1,
    ErasureInventoryCategoryV1,
    ...
    ErasureRecoveryAuthorizationVerifierV1, ErasureRecoveryErrorQueryV1,
    ErasureRecoveryErrorV1, ErasureReferenceV1, ErasureReplayClaimV1,
    ...
    ErasureStateTransitionV1, ErasureStateV1, ErasureVerifiedStateQueryV1, ErasureVerifiedStateV1,
    EvaluatedArtifactClaimV1, PreparedErasureCasV1, PreparedErasureRecoveryErrorV1,
