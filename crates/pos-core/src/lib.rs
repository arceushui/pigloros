...
pub use authority::{
    ...
    DelegateClassV1, DelegationChainV1, ObservationArtifactV1, ObservationRecordDraftV1,
    ObservationRecordV1, ObservationSnapshotDraftV1, ObservationSnapshotV1,
    ObservationStatusV1, PersistedAuthorityV1, PrincipalRefV1, DELEGATE_ACTION_V1,
    MAX_AUTHORITY_DELEGATION_DEPTH, MAX_AUTHORITY_REGISTRY_BINDINGS,
    MAX_AUTHORITY_SCOPE_MEMBERS, MAX_AUTHORITY_SELECTORS, MAX_AUTHORITY_TEXT_BYTES,
    MAX_CAPABILITY_CONSENT_REFERENCES, MAX_CAPABILITY_RECORD_BYTES, MAX_DECISION_RECORD_BYTES,
