...
pub use erasure::{
    ...
    ErasureAuthorizationRejectionV1, ErasureCasEffectV1, ErasureCasOutcomeV1,
    ...
    ErasureFreezeProvenanceV1, ErasureGate, ErasureHostErrorV1, ErasureHostStoreV1,
    ...
    ErasureVerifiedStateQueryV1, ErasureVerifiedStateV1, ErasureVerifiedTopologyObservationV1,
    ErasureVerifiedTopologyProofV1, EvaluatedArtifactClaimV1, PreparedErasureCasV1,
    PreparedErasureForkAdmissionV1, PreparedErasureForkBatchV1, PreparedErasureRecoveryErrorV1,
    RegisteredArtifactV1, ReplayClaimEvaluationV1, ReplayClaimEvaluatorV1, StoredErasureManifestV1,
    ...
    ERASURE_MAX_ATTEMPT_OUTCOMES, ERASURE_MAX_INVENTORY_REQUESTS, ERASURE_MAX_INVENTORY_RESULTS,
    ERASURE_MAX_INVENTORY_TIMELINES, ERASURE_MAX_OBLIGATIONS, ERASURE_MAX_OBLIGATIONS_PER_CATEGORY,
    ERASURE_MAX_OUTCOME_OWNERS, ERASURE_MAX_RECOVERY_ERRORS, ERASURE_MAX_REFERENCES,
    ERASURE_MAX_SCOPE_EXTENSIONS, ERASURE_MAX_TARGETS, ERASURE_OBLIGATION_SET_MAX_BYTES,
    ERASURE_OBLIGATION_SET_TAG_V1, ERASURE_OBLIGATION_TAG_V1, ERASURE_PORTABLE_RECORD_MAX_BYTES,
    ERASURE_RECEIPT_MAX_BYTES, ERASURE_RECEIPT_PROVENANCE_TAG_V1, ERASURE_RECEIPT_TAG_V1,
    ERASURE_RECOVERY_ERROR_TAG_V1, ERASURE_REQUEST_OR_STATE_MAX_BYTES,
