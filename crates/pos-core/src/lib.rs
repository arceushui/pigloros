...
pub use authority::{
    ...
    AuthorityEvaluatorV1, AuthorityGranteeV1,
    ...
    BeliefRecordDraftV1, BeliefRecordV1, CapabilityRevocationDraftV1, CapabilityRevocationV1,
    ...
    MAX_KNOWLEDGE_SNAPSHOT_BYTES, MAX_KNOWLEDGE_SNAPSHOT_RECORDS,
