...
pub use erasure::{
    ...
    erasure_evidence_set_reference, inventory_obligation_reference, selected_obligations_reference,
    ...
    ErasureAttemptOutcomeInputV1, ErasureAttemptOutcomeV1, ErasureCoordinator,
    ...
    ErasureFreezeAdmissionV1, ErasureFreezeFailureInputV1, ErasureFreezeFailureV1,
    ...
    ERASURE_MAX_ATTEMPT_OUTCOMES, ERASURE_MAX_INVENTORY_RESULTS, ERASURE_MAX_REFERENCES,
