...
pub use erasure::{
    ...
    EvaluatedArtifactClaimV1, KeyDestructionArtifactEvidenceV1, PreparedErasureCasV1,
    PreparedErasureForkAdmissionV1, PreparedErasureForkBatchV1, PreparedErasureRecoveryErrorV1,
    RegisteredArtifactV1, ReplayClaimEvaluationV1, ReplayClaimEvaluatorV1, SignatureEvidenceV1,
