...
pub use authority::{
    ...
    ObservationRecordV1, ObservationStatusV1, PersistedAuthorityV1, PrincipalRefV1,
    DELEGATE_ACTION_V1,
    ...
    MAX_CAPABILITY_RECORD_BYTES, MAX_DECISION_RECORD_BYTES, MAX_PERSISTED_AUTHORITY_GRANTS,
