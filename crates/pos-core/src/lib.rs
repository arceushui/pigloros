...
pub use erasure::{
    ...
    ErasureInventoryObservationV1, ErasureInventoryResultV1, ErasureKeyRoleV1, ErasureLifecycleV1,
    ErasureObligationInputV1, ErasureObligationSetInputV1, ErasureObligationSetV1,
    ErasureObligationV1, ErasurePersistedStateV1, ErasurePersistenceObjectV1,
    ...
    PreparedErasureCasV1, PreparedErasureRecoveryErrorV1, RegisteredArtifactV1,
