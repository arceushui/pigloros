...
pub use erasure::{
    ...
    ErasureForkAdmissionInputV1, ErasureForkPersistencePortV1, ErasureForkRecoveryMutationV1,
    ErasureForkRecoveryObjectV1, ErasureForkRecoveryProofV1, ErasureForkRecoveryV1,
