...
pub use erasure::{
    ...
    ErasureCasEffectV1, ErasureCasOutcomeV1, ErasureCoordinator, ErasureCoordinatorPortV1,
    ErasureCoordinatorStateMachineV1,
    ...
    ErasurePersistenceObjectV1, ErasurePersistencePortV1, ErasureReceiptInputV1,
    ...
    ErasureStateTransitionV1, ErasureStateV1, ErasureAttemptQuotaReservationV1,
    ErasureIndexInsertV1, PreparedErasureCasV1, StoredErasureManifestV1,
