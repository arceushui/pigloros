...
pub use erasure::{
    ...
    ErasureRecoveryLimitsV1, ErasureReferenceV1, ErasureRejoinAdmissionV1,
    ...
    ERASURE_MAX_ATTEMPT_OUTCOMES, ERASURE_MAX_INVENTORY_CLASSIFICATIONS,
...
pub use world_replay::{
    WorldReplayAdmissionV1, WorldReplayClosureAuthorityV1, WorldReplayClosureErrorV1,
