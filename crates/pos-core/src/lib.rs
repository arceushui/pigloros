...
pub use erasure::{
    ...
    ErasureCoordinator, ErasureCoordinatorPortV1, ErasureCoordinatorRecordPartsV1,
    ...
    ErasureObligationSetV1, ErasureObligationV1, ErasurePersistenceBundleV1,
    ErasurePersistenceEvidenceV1, ErasurePersistencePortV1, ErasureReceiptInputV1,
    ...
    ErasureScopeExtensionLedgerV1, ErasureScopeExtensionV1, ErasureScopeV1, ErasureStateResolverV1,
    ErasureStateTransitionV1, ErasureStateV1, ErasureSupportingRecordsInputV1,
    ErasureSupportingRecordsV1, VerifiedErasureCoordinatorRecordV1,
    ...
    ERASURE_MAX_ATTEMPT_OUTCOMES, ERASURE_MAX_INVENTORY_RESULTS, ERASURE_MAX_OBLIGATIONS,
    ERASURE_MAX_OBLIGATIONS_PER_CATEGORY, ERASURE_MAX_OUTCOME_OWNERS, ERASURE_MAX_REFERENCES,
    ...
    ERASURE_RECEIPT_MAX_BYTES, ERASURE_RECEIPT_PROVENANCE_TAG_V1,
    ...
    ERASURE_SCOPE_EXTENSION_LEDGER_TAG_V1, ERASURE_SCOPE_EXTENSION_TAG_V1,
