...
use pos_core::{
    ...
    ErasureCoordinatorStateMachineV1, ErasureErrorV1, ErasureFreezeAdmissionEvidenceInputV1,
    ...
    ErasureSupportingRecordsInputV1, ErasureSupportingRecordsV1, ERASURE_PORTABLE_RECORD_MAX_BYTES,
};
