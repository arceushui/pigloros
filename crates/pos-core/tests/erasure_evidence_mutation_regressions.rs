...
use pos_core::{
    ...
    ErasureApplicabilityDecisionV1, ErasureArtifactClassV1, ErasureAuthorizationRejectionInputV1,
    ErasureAuthorizationRejectionV1, ErasureErrorV1, ErasureFreezeAdmissionEvidenceInputV1,
