...
impl Experiment {
    ...
    pub fn with_erasure_gate(mut self, gate: Arc<ErasureContainmentGateV1>) -> Self {
        self.registry = self.registry.with_erasure_gate(gate.clone());
            ...
            pos_core::ExecutableBudgetPolicyV1::new(pos_core::ExecutableBudgetPolicyInputV1 {
                ...
                fidelity_budgets: [
                    pos_core::FidelityBudgetV1 {
                        level: 0,
                        max_events: 1_000,
                        max_bytes: 1_048_576_000,
                        max_cpu_us: 1_000_000,
                ...
                plugin_cpu_reservations: vec![pos_core::PluginCpuReservationV1 {
                    plugin_id: plugin.id(),
                    cpu_reservations_us: [1_000; 3],
                }],
                accounting_semantics: 0,
                execution_profile_hash: Hash::from_bytes([21; 32]),
                max_pass_wall_duration_us: 1_000_000,
            })
